...
class Registration:
    def __init__(self,root):
        ...
        f_name=Label(frame1, text="Firstname", font=("Roboto",12,"bold"), bg="white", fg="black").place(x=50,y=80)
        self.txt_fname=Entry(frame1, font=("Roboto", 12,), bg="light grey")
        self.txt_fname.place(x=50, y=110, width=250,height=35)

        lastname=Label(frame1, text="Lastname", font=("Roboto", 12, "bold"), bg="white", fg="black").place(x=370, y=80)
        self.txt_lname = Entry(frame1, font=("Roboto", 12,), bg="light grey")
        self.txt_lname.place(x=370, y=110, width=250,height=35)

        contact=Label(frame1, text="Contact", font=("Roboto", 12, "bold"), bg="white", fg="black").place(x=50, y=150)
        self.txt_contact = Entry(frame1, font=("Roboto", 12,), bg="light grey")
        self.txt_contact.place(x=50, y=180, width=250,height=35)

        email=Label(frame1, text="Email", font=("Roboto", 12, "bold"), bg="white", fg="black").place(x=370, y=150)
        ...
        question = Label(frame1, text="Security Question", font=("Roboto", 12, "bold"), bg="white", fg="black").place(x=50, y=220)
        ...
        Answer=Label(frame1, text="Answer", font=("Roboto", 12, "bold"), bg="white", fg="black").place(x=370, y=220)
        ...
        Cpassword= Label(frame1, text="Confirm Password", font=("Roboto", 12, "bold"), bg="white", fg="black").place(x=370, y=290)
        self.txt_cpassword = Entry(frame1, font=("Roboto", 12,), bg="light grey")
        self.txt_cpassword.place(x=370, y=320, width=250,height=35)
        self.chk=IntVar()
        chk=Checkbutton(frame1,text="I agree Terms and conditions",onvalue=1,offvalue=0,font=("Robot",12),bg="White").place(x=50,y=380)

        btn=Button(frame1,text="Register",font=("Roboto",10,"bold"),foreground="white", command=self.RegData,bg="#d77337",bd=0,cursor="hand2").place(x=50,y=430,width=100,height=40)
    def RegData(self):
